...
'''
'''
Лучший вариант первый 1-й, рекурсия почти всегда плохой вариант, даже с @functools.lru_cache()
'''
...
# 1000 loops, best of 5: 71.2 nsec per loop 10
# 1000 loops, best of 5: 82.1 nsec per loop 100
